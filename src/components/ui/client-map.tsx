...
type VariantType = "All" | "Destination" | "Hotel" | "Restaurant" | "Mosques";
...
const ClientMap: FunctionComponent<ClientMapProps> = () => {
  ...
  const Markers: (IDestination | IPartner)[] = useMemo(() => {
    ...
    const ht = hotels?.data || [];
    const rest = restaurants?.data || [];
    const mosq = mosques?.data || [];
                      ...
                      <div className="flex items-center gap-2 flex-col">
                        ...
                        <div className="flex items-center justify-center flex-col">
                          ...
                          <Link
                            ...
                            href={`/${
                              variant === "Mosques" || marker.type === undefined
                                ? "destination"
                                : marker.type?.toLocaleLowerCase()
                            }/${marker.id}`}

      ...
      <div className='px-4'>
        ...
        <Card padding='lg' radius='md' mt='md'>
          <Group position='apart' mb='xs'>
            <Group>
              <Avatar
                radius='xl'
                src={
                  'https://images.unsplash.com/photo-1601814933824-fd0b574dd592?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1712&q=80'
                }
              />
          ...
          <Group className='text-primary'>
            ...
            <Text size='sm'>กิจกรรมทัวร์</Text>
          </Group>
          <Group className='text-primary'>
            <IconMapPin size={14} />
            <Text size='sm'>
